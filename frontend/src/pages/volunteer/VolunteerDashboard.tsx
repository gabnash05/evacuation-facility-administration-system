...
export function VolunteerDashboard() {
  ...
  const activeEventsData: Task[] = [
    ...
    { task: "Check-in evacuee", center: "San Lorenzo Parish Church", dateDeclared: "10/06/2022", endDate: "NA", status: "Active" },
    { task: "Transfer Individual", center: "Don Juana Elementary School", dateDeclared: "18/07/2022", endDate: "18/07/2022", status: "Closed" },
    { task: "Register Household", center: "Tibanga Barangay Hall", dateDeclared: "02/08/2022", endDate: "02/08/2022", status: "Closed" },
    { task: "Distribute Relief", center: "Palao Community Center", dateDeclared: "15/09/2022", endDate: "NA", status: "Ongoing" },
    { task: "Request Aid", center: "Hinaplanon Evacuation Center", dateDeclared: "20/10/2022", endDate: "20/10/2022", status: "Closed" },
  ];
