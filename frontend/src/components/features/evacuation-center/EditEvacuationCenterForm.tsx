            ...
            <Dialog open={isOpen} onOpenChange={onClose}>
                <DialogContent className="max-w-md max-h-[85vh] overflow-y-auto">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                        ...
                        <div className="space-y-1.5">
                            <Label className="text-sm font-medium">Center Photo</Label>
                                ...
                                {center?.photo_data && !removeExistingPhoto && !photoPreview ? (
                                    ...
                                    <div className="border border-border rounded-lg bg-background h-full flex flex-col">
                                        <div className="flex-1 min-h-0 flex flex-col items-center justify-center p-2">
                                            {" "}
                                            {/* Added min-h-0 and centered content */}
                                            <div className="relative flex items-center justify-center w-full h-full max-h-16">
                                                {" "}
                                                {/* Fixed max height for image area */}
                                                <img
