...
class IndividualService:
    ...
    def get_all_individuals(params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Args:
            params: Dictionary containing:
                ...
                - assigned_center_id: Restrict records to a household's assigned center
        ...
        try:
            ...
            assigned_center_id = params.get("assigned_center_id")
    ...
    def get_individual_by_id(individual_id: int) -> Dict[str, Any]:
        ...
        try:
            ...
            current_center_info = Individual.get_current_center_for_individual(
                individual_id
            )
            attendance_summary = Individual.get_attendance_history_summary(
                individual_id
            )
        ...
        try:
            ...
            for individual_id in ids:
                if not Individual.get_by_id(individual_id):
                    return {
                        "success": False,
                        "message": f"Individual {individual_id} not found.",
                    }
    ...
    def get_individuals_by_household(household_id: int) -> Dict[str, Any]:
        ...
        try:
            ...
            for ind in individuals:
                if isinstance(ind, dict):
                    ...
                    if ind.get("current_status") == "checked_in":
                        center_info = Individual.get_current_center_for_individual(
                            ind["individual_id"]
                        )
                        if center_info:
                    ...
                    # Serialize model instance
                    ind_data = (
                        response_schema.dump(ind)
                        if hasattr(ind, "individual_id")
                        else dict(ind)
                    )
            ...
            logger.error(
                "Error fetching individuals by household %s: %s",
                household_id,
                str(error),
                exc_info=True,
            )
    ...
    @staticmethod
    def search_individuals_by_name(
        name: str, limit: int = 10, center_id: Optional[int] = None
    ) -> Dict[str, Any]:
        """
        ...
        Args:
            ...
            center_id: Restrict results to the household's assigned center
        ...
        try:
            ...
            individuals = Individual.search_by_name(name, limit, center_id)
            ...
            logger.error(
                "Error searching individuals by name '%s': %s",
                name,
                str(error),
                exc_info=True,
            )
    ...
    def get_status_summary(params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            total_individuals = sum(
                status_data["count"] for status_data in summary.values()
            )
    ...
    def recalculate_all_statuses() -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "data": {"updates": updates, "total_updated": len(updates)},
            }
