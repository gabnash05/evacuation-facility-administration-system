...
| TEST-003A | in progress | 2026-09-03 | — | Added the repository-native module/test mapping, baseline ledger documentation, and a tested verifier. The baseline reports 217 executable modules: 5 mapped and 212 explicitly missing; deterministic coverage batches must close the gaps before strict enforcement is enabled. |
